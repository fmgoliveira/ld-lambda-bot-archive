...
module.exports = {
    name: "whois",
    description: "See some information about a user",
    category: "utility",
    options: [
        {
            type: "USER",
    ...
    async execute(interaction, client) {
        ...
        const embed = new MessageEmbed()
            ...
            .setThumbnail(avatar)
            .addField(`Joined`, `<t:${parseInt(target.joinedTimestamp / 1000)}:F>`, true)
            .addField(`Registered`, `<t:${parseInt(target.user.createdTimestamp / 1000)}:F>`, true)
