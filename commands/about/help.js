...
module.exports = {
    ...
    async execute(interaction, client) {
        ...
        embed.addField("Links zone", `[Invite me](https://bot.lambdadev.xyz/invite) • [Support Server](${process.env.LAMBDA_GUILD_LINK}) • [Dashboard](https://bot.lambdadev.xyz/dashboard) • [Upvote](https://discord.com/channels/878935240377241701/936677696300253204/952186689282002944)`)
        ...
        collector.on("collect", (i) => {
            if (i.values[0] === 'main') {
                ...
                categoryEmbed.addField("Links zone", `[Invite me](https://bot.lambdadev.xyz/invite) • [Support Server](${process.env.LAMBDA_GUILD_LINK}) • [Dashboard](https://bot.lambdadev.xyz/dashboard) • [Upvote](https://discord.com/channels/878935240377241701/936677696300253204/952186689282002944)`)
