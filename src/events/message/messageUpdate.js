            ...
            newMessage.guild.channels.cache.get(logging.channel.messageEvents).send({
                embeds: [
                    new MessageEmbed()
                        ...
                        .addField("Old message", oldMessage.content.length < 1024 && oldMessage.content.lenght > 0 ? oldMessage.content : oldMessage.content.substring(0, 1020) + "...")
                        .addField("New message", newMessage.content.length < 1024 && newMessage.content.lenght > 0 ? newMessage.content : newMessage.content.substring(0, 1020) + "...")
